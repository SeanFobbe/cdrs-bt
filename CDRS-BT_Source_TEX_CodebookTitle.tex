...
{ \scshape \Huge \bfseries Corpus der Drucksachen \\[0.5cm] \Huge \bfseries \scshape des \\[0.5cm] \Huge \bfseries \scshape Deutschen Bundestages \\[0.5cm] \LARGE \bfseries (\datashort )};
